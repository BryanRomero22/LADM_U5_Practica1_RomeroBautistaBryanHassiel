...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        location.requestLocationUpdates(LocationManager.GPS_PROVIDER,0,0f,oyente)
        ...
        baseRemota.collection("tecnologico")
            .addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                ...
                val lis = ArrayAdapter(this, android.R.layout.simple_list_item_1, arreglo)
                lista.adapter = lis
                    ...
                    baseRemota.collection("tecnologico")
                        ...
                        .addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                            ...
                            AlertDialog.Builder(this)
                                .setMessage(p)
                                .setPositiveButton("VER MAPA") {d, p ->
